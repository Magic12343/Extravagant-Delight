...
public class EDFoodValues extends FoodValues {
    ...
    public static final FoodProperties STARFRUIT_CHEESECAKE_SLICE = (new FoodProperties.Builder())
            .nutrition(5).saturationMod(0.1f).fast()
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 800, 1, false, false), 1.0F).build();
    ...
    public static final FoodProperties SWEET_QUINCE_TART_SLICE = (new FoodProperties.Builder())
            .nutrition(5).saturationMod(0.1f).fast()
            .effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), 800, 1), 1.0F)
            .build();
    ...
    public static final FoodProperties SLOE_TREACLE_TART_SLICE = (new FoodProperties.Builder())
            .nutrition(5).saturationMod(0.1f).fast()
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 800, 1, false, false), 1.0F).build();
    ...
    public static final FoodProperties STARFRUIT_MILKSHAKE = (new FoodProperties.Builder())
            .nutrition(8).saturationMod(1.6F).alwaysEat()
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1000, 0, false, false), 1.0F).build();
    ...
    public static final FoodProperties SLOE_BERRY_MILKSHAKE = (new FoodProperties.Builder())
            .nutrition(8).saturationMod(1.6F).alwaysEat()
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1000, 0, false, false), 1.0F).build();

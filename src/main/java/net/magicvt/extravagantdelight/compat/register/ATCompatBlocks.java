...
public class ATCompatBlocks {
    ...
    //Items
    public static final RegistryObject<Item> PASSIONFRUIT_YOGURT = ITEMS.register("passionfruit_yogurt",
            () -> new DrinkableItem(drinkItem().food(EDFoodValues.PASSIONFRUIT_YOGURT), true, false));
